...
namespace TeleYumaApp.Class
{
    ...
    public static class _Global
    {
        ...
        public static class Vistas
        {
            ...
            public static TeleYuma3_0.PagesInicio.ConfirmarTelefono ConfirmarTelefono = new TeleYuma3_0.PagesInicio.ConfirmarTelefono();

            public static TeleYuma3_0.Pages.Pagar Pagar = new TeleYuma3_0.Pages.Pagar();

            public static TeleYuma3_0.Pages.TransferenciaBancaria TransferenciaBancaria = new TeleYuma3_0.Pages.TransferenciaBancaria();

            public static TeleYuma3_0.Pages.ListaRecargas ListaRecargas = new TeleYuma3_0.Pages.ListaRecargas();

            public static TeleYuma3_0.Pages.NewListaPaises PageNewListaPaises = new TeleYuma3_0.Pages.NewListaPaises();

            public static TeleYuma3_0.Pages.PhoneContacs PhoneContacs = new TeleYuma3_0.Pages.PhoneContacs();

            public static TeleYuma3_0.Pages.RespuestaRecarga RespuestaRecarga = new TeleYuma3_0.Pages.RespuestaRecarga();

            public static TeleYuma3_0.Contactos.ListaContactos ListaContactos = new TeleYuma3_0.Contactos.ListaContactos();

            public static TeleYuma3_0.Contactos.Llamar Llamar = new TeleYuma3_0.Contactos.Llamar();

            public static TeleYuma3_0.SMS.Grupos Grupos = new TeleYuma3_0.SMS.Grupos();

            public static TeleYuma3_0.SMS.Mensaje EnviarSMS = new TeleYuma3_0.SMS.Mensaje();

            public static TeleYuma3_0.SMS.NewSMS NewSMS = new TeleYuma3_0.SMS.NewSMS();
        }
